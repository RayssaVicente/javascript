...
let pacientes = ["Lista de paciente\n \n1º Matheus\n2º Marcos\n3° Junior\n4° Luiza\n5°Maria clara "]

const menu = prompt(pacientes + "\n\nOpções" +"\n\nNovo paciente, Consultar paciente, Sair")

switch(menu){
    case "Novo paciente":
     const novoPaciente = prompt("Qual é seu nome:")
     pacientes.push(novoPaciente+ pacientes)
     alert()
