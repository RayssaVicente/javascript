// Arrays podem receber qualquer tipo de dados, inclusive outros 
...
// Arrays podem ter várias "dimensoões"

// Cada par de colchetes referencia um nível mais interno do array

console.log(arr[0])    //Saída: '1° Nível'
console.log(arr[1])    //Saída: ['2° nível', 42, true]
console.log(arr[1][0])   //Saída: '2° nível'
